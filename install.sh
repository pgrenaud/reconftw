...
function install_brew() {
	...
	brew install --formula bash coreutils gnu-getopt python pipx
	brew install --formula massdns jq gcc cmake ruby git curl libpcap wget zip pv dnsutils whois libssl-dev libffi-dev libxml2-dev libxslt-dev zlib libnss3 atk bridge2.0 cups xkbcommon xcomposite xdamage xrandr gbm pangocairo alsa libxml2-utils &>/dev/null
