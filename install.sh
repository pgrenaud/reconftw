...
function install_brew() {
	...
	brew install bash coreutils gnu-getopt python massdns jq gcc cmake ruby git curl libpcap wget zip pipx pv dnsutils whois libssl-dev libffi-dev libxml2-dev libxslt-dev zlib libnss3 atk bridge2.0 cups xkbcommon xcomposite xdamage xrandr gbm pangocairo alsa libxml2-utils &>/dev/null
